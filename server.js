...
const ADMIN_EMAIL = process.env.ADMIN_EMAIL || 'admin@tafuta.com';
...
const HARAKAPAY_WEBHOOK_URL = process.env.HARAKAPAY_WEBHOOK_URL || 'https://your-domain.com/api/webhook/harakapay';
...
app.post('/api/match/random', authenticateToken, async (req, res) => {
    try {
        ...
        // Check free limits if not premium
        if (!isPremium) {
...
app.post('/api/like/:userId', authenticateToken, async (req, res) => {
    try {
        ...
        // Check if premium for unlimited likes
...
app.post('/api/messages', authenticateToken, async (req, res) => {
    try {
        ...
        // Check if user is premium for unlimited messages
...
app.post('/api/payments/initiate', authenticateToken, async (req, res) => {
    try {
        ...
        // Update payment with order ID from HarakaPay
