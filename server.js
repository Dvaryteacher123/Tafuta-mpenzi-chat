...
// ============================================
// ⭐⭐⭐ SERVE STATIC FILES - MUHIMU! ⭐⭐⭐
// ============================================

// 1. KWANZA: Serve static files from root directory
// Hii inahakikisha CSS, JS, images zinapakizwa vizuri
app.use(express.static(__dirname));

// 2. PILI: Serve static files from public folder (kama ipo)
app.use(express.static(path.join(__dirname, 'public')));

// 3. TATU: Serve CSS folder specifically
app.use('/css', express.static(path.join(__dirname, 'css')));
app.use('/js', express.static(path.join(__dirname, 'js')));

// ============================================
// ⭐⭐⭐ SERVE HTML FILES - ROUTES ⭐⭐⭐
// ============================================
...
function serveHTMLFile(filename, res) {
    ...
    return res.status(404).send(`
        ...
        <p>File not found in any location.</p>
...
// Main routes - ZIWE KABLA YA CATCH-ALL
app.get('/', (req, res) => {
...
app.get('/chat.html', (req, res) => {
    serveHTMLFile('chat.html', res);
});

app.get('/premium.html', (req, res) => {
    serveHTMLFile('premium.html', res);
});

app.get('/admin.html', (req, res) => {
    serveHTMLFile('admin.html', res);
});
...
app.use((req, res) => {
    ...
    // Otherwise, serve index.html (SPA behavior)
    serveHTMLFile('index.html', res);
});
